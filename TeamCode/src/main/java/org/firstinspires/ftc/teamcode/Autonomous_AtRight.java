...
@Autonomous(name="Autonomous_AtRight", group = "IFR2024")
public class Autonomous_AtRight extends LinearOpMode {
...
//                                 .splineToLinearHeading(new Pose2d(18.65, 15.32, Math.toRadians(180)), Math.toRadians(182.68))
        ...
        drive.followTrajectory(drive.trajectoryBuilder(new Pose2d()).forward(1).build());
...
//        drive.followTrajectory(drive.trajectoryBuilder(new Pose2d()).forward(40).build());
...
//
//        drive.followTrajectory(drive.trajectoryBuilder(new Pose2d()).forward(10).build());
